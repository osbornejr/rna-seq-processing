...
# rule reference:
# 	input:
# 		fasta="reference-input/{REF_GENOME}.fasta.gz",
# 		gtf="reference-input/{REF_GENOME}.gtf"
# 	output:
...
# rule align:
# 	input:
# 		r1 = 'clean-reads/{SAMPLE}_read_1.fastq.gz',
# 		r2 = 'clean-reads/{SAMPLE}_read_2.fastq.gz',
# 		ref_genome = directory('reference-index/{REF_GENOME}')
#
# 	params:
...
# 		directory('splice-junctions')
# 	output:
# 		'splice-junctions/{SAMPLE}_pass_1SJ.filtered.tab'
# 	threads: 1
# 	shell:
